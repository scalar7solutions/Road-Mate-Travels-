...
const mainNavItems: NavItemWithSubmenu[] = [
...

  {
    ...
    icon: MapPinned,
    submenu: [
      { title: 'Destination Groups', href: route('destinationgroups.index') },
      { title: 'Places', href: route('places.index') },
    ],
  },

  { title: 'Tour Packages', href: route('tourpackages.index'), icon: Briefcase },
  { title: 'Rental Packages', href: route('rentalpackages.index'), icon: Truck },
