...
import AlertError from '@/Backend/components/AlertError.vue';
...
import {
    ...
    PinInputGroup,
    PinInputSlot,
} from '@/Backend/components/ui/pin-input';
import { useTwoFactorAuth } from '@/Backend/composables/useTwoFactorAuth';
